...
return array(
    ...
    "FEEDBACK_FILE_IS_NOT_CHOSEN" => "Please, choose a file!",
    "FEEDBACK_CSV_FILE_INVALID" => "Sorry, only 'CSV' file allowed!",
    "FEEDBACK_FILE_UPLOADED" => "File has been uploaded successfuly!",
);
