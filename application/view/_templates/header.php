...
<body>
    ...
    <div class="wrapper">
        ...
        <ul class="navigation">
            ...
            <li <?php if (View::checkForActiveController($filename, "bulkview")) { echo ' class="active" '; } ?> >
                <a href="<?php echo Config::get('URL'); ?>bulkview/index">View Bulk Uploads</a>
            </li>
            ...
            <?php if (Session::userIsLoggedIn()) { ?>
                ...
                <li <?php if (View::checkForActiveController($filename, "note")) { echo ' class="active" '; } ?> >
                 ...
                 <li <?php if (View::checkForActiveController($filename, "bulk")) { echo ' class="active" '; } ?> >
                    <a href="<?php echo Config::get('URL'); ?>bulk/upload">Bulk Upload</a>
                </li>
            <?php } else { ?>
